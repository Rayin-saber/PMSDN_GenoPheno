...
These symptoms included `r result_for_group("Feeding difficulties")`, as well as the need for naso-gastric tubes (`r pvalue("Nasogastric tube")`) and difficulties are not explained by feeding disorders (e.g. PICA (`r pvalue("Pica")`)).
