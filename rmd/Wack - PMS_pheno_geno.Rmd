...
No treatment are yet available, although one drug candidate, IGF1 (Insuline-like Growth Factor 1), has been used successfully in a phase 2 randomized controlled trial.[@kolevzon_pilot_2014]
...
> Febrile seizures (`r pvalue("Tonic-clonic seizures")`).
...
At the same time, verbal speech (`r result_for_group("Verbal communication")`) was heavily impaired for patients, even those with even small deletions.
...
```{r table1}
desctable:::pander.desctable(article$table1,
